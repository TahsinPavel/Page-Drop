...
Welcome to the PageDrop codebase. This file provides the full context of the project architecture, tech stack, and key workflows. It is intended to help AI assistants (Codex, ChatGPT, Gemini, etc.) quickly understand the project.
