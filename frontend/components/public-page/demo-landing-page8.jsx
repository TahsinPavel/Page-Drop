...
const PRODUCTS = [
  {
    id: 1,
    name: "Phantom Glide",
    benefit: "Designed to deliver all-day comfort with a premium look that stands out.",
    sub: "Lightweight build. Seamless experience. Built for everyday performance.",
    price: "$249",
    originalPrice: "$299",
    badge: "Most Popular",
    rating: 4.8,
    urgencyNote: "Limited stock available today",
    glow: "rgba(52,211,153,0.45)",
    image: "/demo/sneaker-1.png",
  },
  {
    id: 2,
    name: "Nova Chronograph",
    benefit: "Elevate your presence with a timepiece that speaks confidence and ambition.",
    sub: "Precision movement. Scratch-resistant glass. Crafted for the bold.",
    price: "$589",
    originalPrice: "$749",
    badge: "Editor's Pick",
    rating: 4.9,
    urgencyNote: "Only 8 units remaining",
  ...
  },
  {
    ...
    benefit: "Feel every beat with studio-grade audio wrapped in everyday comfort.",
    sub: "Active noise cancellation. 40-hour battery. Featherlight fit.",
    price: "$349",
    originalPrice: "$429",
    badge: "Best Seller",
    rating: 4.7,
    urgencyNote: "Restocked today — selling fast",
    glow: "rgba(251,191,36,0.42)",
    image: "/demo/headphones-1.png",
  },
  {
    id: 4,
    name: "Echo Wireless Pro",
    benefit: "Unleash immersive sound that matches your lifestyle — anywhere, anytime.",
    sub: "Deep bass. Crystal highs. Ergonomic design for hours of wear.",
    price: "$279",
    originalPrice: "$359",
    badge: "Trending",
    rating: 4.8,
    urgencyNote: "Most wishlisted this week",
  ...
  },
  {
    id: 5,
    name: "Aether Runner",
    benefit: "Step into cloud-like comfort that fuels your confidence from dawn to dusk.",
    sub: "Adaptive cushioning. Breathable mesh. Designed for movers.",
    price: "$219",
    originalPrice: "$289",
    badge: "New Arrival",
    rating: 4.6,
    urgencyNote: "Launch week pricing — ends soon",
...
const FEATURE_CARDS = [
  {
    ...
    desc: "Hand-picked and quality-certified. Every product meets our premium standard before it reaches you.",
  },
  {
    icon: Truck,
    title: "Fast Delivery",
    desc: "Express shipping with real-time tracking. From warehouse to your door in record time.",
  },
  {
    icon: RotateCcw,
    title: "Easy Ordering",
    desc: "Order via WhatsApp in 60 seconds. Pay on delivery. Hassle-free returns within 30 days.",
  },
];
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {product.rating && (
          <span className="ml-2 inline-flex items-center gap-1.5 rounded-full border border-amber-300/15 bg-amber-300/10 px-3 py-1.5 text-[11px] font-bold text-amber-200">
        ...
        {product.sub && <p className="mt-1 text-[13px] leading-relaxed text-white/50">{product.sub}</p>}
        ...
        <p className="mt-2 text-center text-xs text-white/45">No payment required now • Ask anything first</p>
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-white/85">2,340+ happy customers</p>
        </div>
      </motion.div>
    </AnimatePresence>
  );
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">Premium quality, fast delivery, easy ordering.</h2>
          </div>
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-white/50">Customer Stories</p>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">What our customers are saying.</h2>
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-5xl rounded-3xl border border-white/[0.12] bg-[linear-gradient(135deg,rgba(16,185,129,0.18)_0%,rgba(15,23,42,0.92)_55%,rgba(3,7,17,0.96)_100%)] p-8 text-center shadow-[0_40px_100px_rgba(0,0,0,0.45)] sm:p-14">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-white/65">
            Browse, choose, and order in under 60 seconds. Pay on delivery. Free shipping. Hassle-free returns.
          </p>
